...
export default {
	...
	data: function () {
		return {
			cdn,
			agency: [{color: '#d4b655', name: 'Kantar'}, {color: '#21BBE1', name: 'Median'}, {color: '#D75F5F', name: 'STEM'}, {color: '#1964aa', name: 'NMS Market Research'}, {color: '#1964aa', name: 'NMS'}], // 'CVVM', 'Data Collect', 'Ipsos',
			agencySelected: null,
			width: 0,
			tick: 1,
			el: null,
