...
export default {
  ...
  components: {
	...
	computed: {
		...
		town: function () {
			var d = this.$store.getters.pdv('history/core/cr');
		...
		current: function () {
			return this.town ? this.$store.getters.pdv('history/current/cr') : null;
		},
		history: function () {
			return this.showHistory ? this.$store.getters.pdv('history/history/cr') : null;
		},
		$core: function () {
