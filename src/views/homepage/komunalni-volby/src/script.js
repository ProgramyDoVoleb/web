...
export default {
	...
	computed: {
		...
		parties: function () {
			return this.$store.getters.pdv('parties/as-of/' + this.elections.datum + ';1,7,47,53,166,703,720,721,768,1114,714,5,1227,1245,1265,1178,1298,1722,88,1298,129,181,1228');
		}
	},
	methods: {
		sortBy, shuffle,
